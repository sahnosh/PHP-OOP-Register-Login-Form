...
header("location:medicine.php?msg=Record Inserted");
}
...
header("location:medicine.php?msg=Record Updated Successfully");
}
...
header("location:medicine.php?msg=Record Deleted Successfully");
}
